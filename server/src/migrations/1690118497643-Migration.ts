...
export class Migration1690118497643 implements MigrationInterface {
  name = 'Migration1690118497643';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`products\` DROP COLUMN \`to_remove\``
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`products\` ADD \`to_remove\` int NOT NULL`
    );
    await queryRunner.query(
      `ALTER TABLE \`products\` ADD \`discount\` int NULL`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`products\` ADD \`price\` decimal(6,2) NOT NULL`
    );
    await queryRunner.query(`ALTER TABLE \`products\` DROP COLUMN \`price\``);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`products\` DROP COLUMN \`price\``);
    await queryRunner.query(
      `ALTER TABLE \`products\` ADD \`price\` float(12) NOT NULL`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`products\` ADD \`discount\` float NULL DEFAULT 'NULL'`
    );
    await queryRunner.query(
      `ALTER TABLE \`products\` ADD \`to_remove\` int NULL DEFAULT '0'`
    );
    await queryRunner.query(
